...
ALTER TABLE `TZZ_VIAJE`
    ADD CONSTRAINT `Viaje_Factoria` FOREIGN KEY (`ViaFacCod`) REFERENCES `EZM_FACTORIA` (`FacCod`) ON DELETE NO ACTION ON UPDATE NO ACTION
;
...
ALTER TABLE `E3M_ALMACEN`
    ADD CONSTRAINT `Factoria_Almacen` FOREIGN KEY (`AlmFacCod`) REFERENCES `EZM_FACTORIA` (`FacCod`) ON DELETE RESTRICT ON UPDATE RESTRICT
;
...
ALTER TABLE `RZC_FACTORIA_EMPLEO`
    ADD CONSTRAINT `Factoria_Empleo_Factoria` FOREIGN KEY (`FacCod`) REFERENCES `EZM_FACTORIA` (`FacCod`) ON DELETE RESTRICT ON UPDATE RESTRICT
;
